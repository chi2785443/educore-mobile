      ...
      <View style={{
        ...
        {s.profilePicture ? (
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 15, fontWeight: '900', color: '#0ea5e9' }}>
        ...
        <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
          ...
          {child.gradeLevel && (
            <View style={{ backgroundColor: '#e0f2fe', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3 }}>
              <Text style={{ fontSize: 10, fontWeight: '700', color: '#0ea5e9' }}>{child.gradeLevel}</Text>
            </View>
          )}
...
export default function MyChildrenResultsScreen() {
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12, marginTop: 2 }}>
              Select a child to view their term results
            </Text>
          </View>
          <View style={{
            width: 36, height: 36, borderRadius: 12,
          ...
          {isLoading ? (
            ...
            children.map(child => (
              <ChildRow
                key={child.id}
                child={child}
                onPress={() => child.student && router.push(`/my-children-results/${child.student.id}` as never)}
              />
            ))
          )}
        </View>
