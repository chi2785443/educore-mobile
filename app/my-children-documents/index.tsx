      ...
      <View style={{
        ...
        {s.profilePicture ? (
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 15, fontWeight: '900', color: '#059669' }}>
        ...
        <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
          ...
          {child.gradeLevel && (
            <View style={{ backgroundColor: '#d1fae5', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3 }}>
              <Text style={{ fontSize: 10, fontWeight: '700', color: '#059669' }}>{child.gradeLevel}</Text>
            </View>
          )}
...
export default function MyChildrenDocumentsScreen() {
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{
            ...
            <Ionicons name="folder-outline" size={18} color="rgba(255,255,255,0.8)" />
          </View>
        </View>
      </View>
          ...
          {isLoading ? (
            ...
            children.map(child => (
              <ChildRow
                key={child.id}
                child={child}
                onPress={() => child.student && router.push(`/my-children-documents/${child.student.id}` as never)}
              />
            ))
          )}
        </View>
